...
7. Run GXMetal Test. Do not rely on the startup icon alone: the test confirms
   ...
   2.1.1 rejects a mismatched driver and tells you to reinstall and restart.
...
tests. GXMetal 2.1.1 has been exercised through their title screens and
