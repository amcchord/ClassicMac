...
7. Run GXMetal Test. Do not rely on the startup icon alone: the test confirms
   ...
   2.3.0 rejects a mismatched driver and tells you to reinstall and
   restart.
...
GXMetal 2.3.0 has reviewed gameplay evidence for Bugdom, Future Cop, Combat
