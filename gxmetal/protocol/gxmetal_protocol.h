...
enum GXMetalStateTag {
    ...
    GXMETAL_STATE_FOG_MODE     = 17,
    GXMETAL_STATE_FOG_COLOR_A  = 18,
    GXMETAL_STATE_FOG_COLOR_R  = 19,
    GXMETAL_STATE_FOG_COLOR_G  = 20,
    GXMETAL_STATE_FOG_COLOR_B  = 21,
    GXMETAL_STATE_FOG_START    = 22,
...
enum GXMetalFogMode {
    GXMETAL_FOG_NONE                = 0,
    GXMETAL_FOG_ALPHA               = 1,
    GXMETAL_FOG_LINEAR              = 2,
    GXMETAL_FOG_EXPONENTIAL         = 3,
    GXMETAL_FOG_EXPONENTIAL_SQUARED = 4
};

enum GXMetalAlphaTestFunction {
    GXMETAL_ALPHA_TEST_NONE = 0,
    GXMETAL_ALPHA_TEST_LT   = 1,
    GXMETAL_ALPHA_TEST_EQ   = 2,
    GXMETAL_ALPHA_TEST_LE   = 3,
...
#define GXMETAL_CONTEXT_CLIP_LEFT_TOP_OFFSET       24u
#define GXMETAL_CONTEXT_CLIP_RIGHT_BOTTOM_OFFSET   28u
/* Version 1.0-1.3 required these words to be zero. */
#define GXMETAL_CONTEXT_RESERVED0_OFFSET \
    GXMETAL_CONTEXT_CLIP_LEFT_TOP_OFFSET
#define GXMETAL_CONTEXT_RESERVED1_OFFSET \
    GXMETAL_CONTEXT_CLIP_RIGHT_BOTTOM_OFFSET
