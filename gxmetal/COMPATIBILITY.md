...
| ATI private bridge | OpenGLRendererATI hooks, two-stage lightmaps, NoCopy refresh, pointer-fan clip markers, and private ARGB4444 | Supported compatibility path; zero and nonzero slot-60 clip markers both submit valid pointer fans, and private ARGB4444 draws accept the negative top-origin and nonnegative RAVE V conventions observed in shipping callers | Quake III Q3DM1 missing-world oracle, Oni transition oracle, Carmageddon II, Future Cop, native ATI tests, and host tests with clamp-sensitive vertical gradients |
